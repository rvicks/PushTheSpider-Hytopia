...
/**
 * A direct camera implementation that uses only the most basic Hytopia SDK camera functions
 */
export class DirectCamera {
    /**
     ...
     * Enable mouse look
     */
    public static enableMouseLook(player: Player): void {
        try {
            player.ui.sendData({
